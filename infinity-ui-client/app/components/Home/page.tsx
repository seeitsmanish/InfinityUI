...
const Home = ({ }: HomePropsType) => {
    return (
        <div className="h-[100dvh] w-[100dvw] bg-zinc-950 text-white overflow-hidden">
            <div className="max-w-[1080px] mx-auto h-full flex flex-col">
                ...
                <div className="flex flex-1 flex-col items-center justify-center gap-4 md:gap-5 relative px-4">
