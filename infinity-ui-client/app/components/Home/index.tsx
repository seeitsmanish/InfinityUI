            ...
            <div className="max-w-[1080px] mx-auto h-full flex flex-col">
                ...
                <div className="flex flex-1 flex-col items-center justify-center gap-4 md:gap-5 px-4">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4 md:gap-8">
                        {/* Explore Components */}
                        <Link href="/docs" className="relative inline-flex h-12 w-full sm:w-auto overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
