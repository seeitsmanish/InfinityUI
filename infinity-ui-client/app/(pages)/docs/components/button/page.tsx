...
`;
    ...
    const tabs: Record<string, TabItem[]> = {
        variants: [
            ...
            { index: 2, title: 'Code', content: <CodePreview code={variantCode} language="html" />, className: 'h-full w-full' }
        ],
        sizes: [
            { index: 1, title: 'Preview', content: 'Preview', className: '' },
            { index: 2, title: 'Code', content: <CodePreview code={sizeCode} language="html" />, className: 'h-full w-full' }
        ],
        disabled: [
            { index: 1, title: 'Preview', content: 'Preview', className: '' },
            { index: 2, title: 'Code', content: <CodePreview code={disabledCode} language="html" />, className: 'h-full w-full' }
        ],
        ripple: [
            { index: 1, title: "Preview", content: "Preview", className: "" },
            { index: 2, title: "Code", content: <CodePreview code={rippleCode} language="html" />, className: "h-full w-full" },
        ]
    };
